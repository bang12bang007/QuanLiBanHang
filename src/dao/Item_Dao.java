...
// xóa sản phẩm theo id
	...
	public Item getItemByID(String id) throws SQLException {
        try {
            ...
            if(rs.next()) {
                return new Item(rs.getString("id"), rs.getString("name"), rs.getDouble("price"), rs.getInt("quantity"), rs.getString("category"), rs.getTimestamp("created_at"), rs.getDate("expiredDate"));
            }
